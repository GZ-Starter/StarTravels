...
<!-- Mirrored from kiswa.net/themes/star-travel/demo/demo-ltr/tour-detail-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Apr 2023 06:44:01 GMT -->
                    ...
                    <ul class="navbar-nav ml-auto navbar-search-link">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="dropdown-item" href="tour-detail-right-sidebar.html">Detail Right Sidebar</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                        ...
                        <div class="collapse sub-menu" id="tours-links">
                            ...
                            <a class="items-list active" href="tour-detail-right-sidebar.html">Detail Right Sidebar</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Tour Detail Right Sidebar</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                    ...
                    <div class="row">
                                            ...
                                            <div id="tour-information" class="tab-pane in active">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 col-lg-8 tab-text">
                                                        <h3><?php echo $fetch_package['name']; ?></h3>
                                                        <p><?php echo $fetch_package['packagedetails']; ?></p>
                                                    </div><!-- end columns -->
                                                </div><!-- end row -->
                        ...
                        <div class="col-12 col-md-12 col-lg-3 side-bar right-side-bar">
                            ...
                            <div class="side-bar-block booking-form-block">
                                <h2 class="selected-price"><?php echo $fetch_package['price']; ?> <span><?php echo $fetch_package['name']; ?></span></h2>

                                <div class="booking-form">
                                    <h3>Book Tour</h3>
                                    <p>
                                    <h6>Find your dream tour today</h6>
                                    </p>

                                    <form id="tour_frm_booking" name="tour_frm_booking" method="post">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Country" id="txt_country" name="txt_country" />
                                        </div>
