...
if (isset($_POST['btnsend'])) {
    ...
    $insert = "SELECT * FROM tblnewsletter WHERE email='$email'";
...
if (isset($_POST['save'])) {
    ...
    $add=$_POST['address'];
    $phone=$_POST['phone'];
    $insert = "UPDATE tblregister SET name='$name',dob='$dob',address='$add',phone='$phone' WHERE email='$email'";
    mysqli_query($conn, $insert);
    if ($insert) {
...
<!-- Mirrored from kiswa.net/themes/star-travel/demo/demo-ltr/user-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Apr 2023 06:44:44 GMT -->
                ...
                <div class="collapse navbar-collapse" id="myNavbar1">
                    <ul class="navbar-nav ml-auto navbar-search-link">
                        <li class="nav-item dropdown">
                            <a href="landing-page.php" class="nav-link" id="navbarDropdown" role="button" d aria-haspopup="true" aria-expanded="false">Home<span></span></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="active"><a href="user-profile.html">User Profile</a></li>
            ...
            <nav id="sidebar" class="sidenav">
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                        ...
                        <!-- <a class="items-list active" href="#pages-links" data-toggle="collapse"><span><i class="fa fa-clone link-icon"></i></span>Pages<span><i class="fa fa-chevron-down arrow"></i></span></a>
                        <div class="collapse sub-menu" id="pages-links">
                            ...
                            <a class="items-list active" href="user-profile.html">User Profile</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Change Password</a></li></li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="dashboard-heading">
                                <h2>Traveller <span>Profile</span></h2>

                                <p>Hi <?php echo $uname; ?>, Welcome to Star Travels!</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-2 col-lg-2 dashboard-nav">
                                        <ul class="nav nav-tabs text-center">
                                            <!-- <li class="nav-item"><a class="nav-link" href="dashboard-1.html"><span><i class="fa fa-cogs"></i></span>Dashboard</a></li> -->
                                            <li class="nav-item active"><a class="nav-link" href="#"><span><i class="fa fa-user"></i></span>Profile</a></li>
                                            <li class="nav-item"><a class="nav-link" href="userbooking.php"><span><i class="fa fa-briefcase"></i></span>Booking</a></li>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <?php
                                                    $SELECT = mysqli_query($conn, "SELECT * FROM tblregister WHERE name='$uname'");
                                                    ...
                                                    ?>
                                                            ...
                                                            <div class="col-md-7 col-lg-8  user-detail">
                                                                <ul class="list-unstyled" style="color: black;">
                                                                    <li><span>Name:</span> <?php echo $uname; ?></li>
                                                                    <li><span>Date of Birth:</span> <?php echo $fetch['dob']; ?></li>
                                                                    <li><span>Email:</span> <?php echo $fetch['email']; ?></li>
                                                                    <li><span>Phone:</span> <?php echo $fetch['phone']; ?></li>
                                                                    <li><span>Address:</span> <?php echo $fetch['address']; ?></li>
                    ...
                    <div class="modal-body">
                        <form method="POST">
                            <div class="form-group">
                                ...
                                <input name='name' type="text" class="form-control" placeholder="Name" value="<?php echo $fetch['name'] ?>" />
                            </div><!-- end form-group -->

                            <div class="form-group">
                                <label style="color: black;">Date of Birth</label>
                                <input name='dob' type="date" class="form-control" placeholder="mm-dd-yy" value="<?php echo $fetch['dob'] ?>" />
                            </div><!-- end form-group -->

                            <div class="form-group">
                                <label>Your Email</label>
                                <input name='email' type="hidden" class="form-control" placeholder="Email" value="<?php echo $fetch['email'] ?>" />
                            </div><!-- end form-group -->

                            <div class="form-group">
                                <label style="color: black;">Your Phone</label>
                                <input name='phone' type="text" class="form-control" placeholder="Phone Number" value="<?php echo $fetch['phone'] ?>" />
                            </div><!-- end form-group -->

                          

                            <div class="form-group">
                                <label style="color: black;">Your Address</label>
                                <input name='address' type="text" class="form-control" placeholder="Address" value="<?php echo $fetch['address'] ?>" />
                            </div><!-- end form-group -->


                        <input type='submit' value='Save Changes' style="background:orange; border-radius:5px; color:white; height:25px; text-align:center;" name='save'>
