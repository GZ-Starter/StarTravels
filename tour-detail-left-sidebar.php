...
<!-- Mirrored from kiswa.net/themes/star-travel/demo/demo-ltr/tour-detail-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Apr 2023 06:43:56 GMT -->
<head>
                    ...
                    <ul class="navbar-nav ml-auto navbar-search-link">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="dropdown-item" href="tour-detail-left-sidebar.html">Detail Left Sidebar</a></li>
            ...
            <nav id="sidebar" class="sidenav">
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <a class="items-list active" href="#tours-links" data-toggle="collapse"><span><i class="fa fa-globe link-icon"></i></span>Tours<span><i class="fa fa-chevron-down arrow"></i></span></a>
                                <div class="collapse sub-menu" id="tours-links">
                                    ...
                                    <a class="items-list active" href="tour-detail-left-sidebar.html">Detail Left Sidebar</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Tour Detail Left Sidebar</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                ...
                <div class="container">
                    <div class="row">            
                        ...
                        <div class="col-12 col-md-12 col-lg-3 side-bar left-side-bar">
                            ...
                            ?>
                                <h2 class="selected-price">₹<?php echo $fetch_package['price']; ?> <span>per person  </span> <?php echo $fetch_package['name']; ?></h2>
                                <?php
                            };
                        };
                        ?>
                                <div class="booking-form">
                                    ...
                                    <form  method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="First Name" id="txt_first_name" name="fname" required/>
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Last Name"  id="txt_last_name" name="lname" required/>
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="email" class="form-control" placeholder="Email"  id="txt_email" name="email" required/>
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Phone"  id="txt_phone" name="phone" required/>
                                        </div>
                                        
                                        <!-- <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Country"  id="txt_country" name="place"/>
                                        </div> -->
                                        
                                        <div class="form-group">
                                            <input type="date" class="form-control dpd3" placeholder="Booking Date" id="txt_booking_date" name="tdate"required/>
                                        </div>
                                        ...
                                        <div class="checkbox custom-check">
                                            ...
                                            <label for="check01"><span><i class="fa fa-check" required></i></span>By continuing, you are agree to the <a href="page.php?type=Terms">Terms & Conditions.</a></label>
                                        </div>
                                        <!-- <div class="col-md-12 text-center" id="result_msg"></div> -->
                                        <input type="submit" name="confirm" value="Confirm Booking">
                                        <!-- <button class="btn btn-block btn-orange" type="submit" id="submit" name="confirm">Confirm Booking</button> -->
                                    </form>
                        ...
                        <?php
                            ...
                            <div class="detail-slider">
                                ...
                                <div><img src="KarnatakaImages/<?php echo $fetch_package['image']; ?>" class="img-fluid" alt="feature-img" /></div>
                                    <!-- <div><img src="images/t-feature-2.jpg" class="img-fluid" alt="feature-img"/></div>
                                    <div><img src="images/t-feature-3.jpg" class="img-fluid" alt="feature-img"/></div>
                                    <div><img src="images/t-feature-4.jpg" class="img-fluid" alt="feature-img"/></div>
                                    <div><img src="images/t-feature-5.jpg" class="img-fluid" alt="feature-img"/></div> -->
                                </div><!-- end feature-slider -->
                                
                                <!-- <div class="feature-slider-nav">
                                    <div><img src="images/t-feature-thumb-1.jpg" class="img-fluid" alt="feature-thumb"/></div>
                                    <div><img src="images/t-feature-thumb-2.jpg" class="img-fluid" alt="feature-thumb"/></div>
                                    <div><img src="images/t-feature-thumb-3.jpg" class="img-fluid" alt="feature-thumb"/></div>
                                    <div><img src="images/t-feature-thumb-4.jpg" class="img-fluid" alt="feature-thumb"/></div>
                                    <div><img src="images/t-feature-thumb-5.jpg" class="img-fluid" alt="feature-thumb"/></div>
                                </div> -->
                                
                                <ul class="list-unstyled features tour-features">
                                    <li><div class="f-icon"><i class="fa fa-wheelchair"></i></div><div class="f-text"><p class="f-heading">Seats</p><p class="f-data">5</p></div></li>
                                    <li><div class="f-icon"><i class="fa fa-briefcase"></i></div><div class="f-text"><p class="f-heading"></p><p class="f-data">Impressive packages</p></div></li>
                            ...
                            <div class="detail-tabs">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="tour-information" class="tab-pane in active">
                                        <div class="row">
                                            <!-- <div class="col-md-4 col-lg-4 tab-img"> -->
                                                <!-- <img src="images/hotel-detail-tab-1.jpg" class="img-fluid" alt="flight-detail-img" /> -->
                                            <!-- </div> -->
                                            
                                            <div class="col-md-8 col-lg-8 tab-text">
                                                        <h3  style="color:black;font-size:23px;font-weight:bold;"><?php echo $fetch_package['name']; ?></h3>
                                                        <p style="font-size:18px;"><?php echo $fetch_package['packagedetails']; ?></p>
                                                        <span style="color:black;font-size:23px;font-weight:bold;">We Offer:</span>
                                                        <p style="font-size:18px;"><?php echo $fetch_package['packagefeatures']; ?></p>
                                    ...
                                    <div id="flight" class="tab-pane">
                                        <div class="row">
                                            <div class="col-md-4 col-lg-4 tab-img">
                                                <img src="images/hotel-detail-tab-2.jpg" class="img-fluid" alt="flight-detail-img" />
                                            </div><!-- end columns -->
                                    ...
                                    <div id="map-overview" class="tab-pane">
                                        <div class="row">
                                            <div class="col-md-4 col-lg-4 tab-img">
                                                <img src="images/hotel-detail-tab-3.jpg" class="img-fluid" alt="flight-detail-img" />
                                            </div><!-- end columns -->
                            ...
                            <!-- <div class="available-blocks" id="available-tours">
                                    ...
                                    <div class="list-content">
                                        <div class="main-img list-img t-list-img">
                                            <a href="tour-detail-left-sidebar.html">
                                                <img src="images/tour-list-1.jpg" class="img-fluid" alt="tour-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="list-inline-item price">$568.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                                ...
                                <div class="list-block main-block t-list-block">
                                    <div class="list-content">
                                        <div class="main-img list-img t-list-img">
                                            <a href="tour-detail-left-sidebar.html">
                                                <img src="images/tour-list-2.jpg" class="img-fluid" alt="tour-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="list-inline-item price">$568.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                                ...
                                <div class="list-block main-block t-list-block">
                                    <div class="list-content">
                                        <div class="main-img list-img t-list-img">
                                            <a href="tour-detail-left-sidebar.html">
                                                <img src="images/tour-list-3.jpg" class="img-fluid" alt="tour-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="list-inline-item price">$568.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                                ...
                                <div class="list-block main-block t-list-block">
                                    <div class="list-content">
                                        <div class="main-img list-img t-list-img">
                                            <a href="tour-detail-left-sidebar.html">
                                                <img src="images/tour-list-4.jpg" class="img-fluid" alt="tour-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="list-inline-item price">$568.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                        ...
                        <form method="post">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn"><button class="btn btn-lg" name="submit"><i class="fa fa-envelope"></i></button></span>
                                </div>
                            </div>
                        </form>
                    </div><!-- end columns -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-6 col-xl-6" id="copyright">
                            <p>© 2023 TheTraveller</a>. All rights reserved.</p>
                        </div><!-- end columns -->
...
<!-- Mirrored from kiswa.net/themes/star-travel/demo/demo-ltr/tour-detail-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Apr 2023 06:44:00 GMT -->
</html>
