...
<!-- Mirrored from kiswa.net/themes/star-travel/demo/demo-ltr/travel-agency-homepage.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Apr 2023 06:43:18 GMT -->
    ...
    <div class="wrapper">
        ...
        <div class="header-absolute">
            ...
            <nav class="navbar navbar-expand-xl sticky-top main-navbar navbar-custom bg-light" id="mynavbar-2">
                ...
                <a href="#" class="navbar-brand py-1 my-auto pl-md-2 m-0"><span><i class="fa fa-plane"></i>THE</span>TRAVELER</a>
            ...
            <ul class="slides">
                ...
                <li class="item-1 back-size" style="background:linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url(images/travel-agency-slider-1.jpg) 50% 60%; background-size:142%; height:100%;">
                    <div class="meta">
                        <div class="container">
                            <h2>Karnataka</h2>
                            <p>Discover best places of Karnataka within affordable budget range.</p>
                            <span class="highlight-price">STARTING FROM ₹2000 ONLY</span>
                        </div><!-- end container -->
                    </div><!-- end meta -->
                </li><!-- end item-1 -->

                <li class="item-2 back-size" style="background:linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url(KarnatakaImages/Elaniuru-waterfalls-Kathyanamakki-trekking.jpg) 50% 60%; background-size:142%; height:100%;">
                    <div class=" meta">
                        <div class="container">
                            <h2>Karnataka</h2>
                            <p>Discover best places of Karnataka within affordable budget range.</p>
                                ...
                                <div class="item">
                                    <div class="main-block tour-block">
                                        ...
                                        <div class="offer-price-2">
                                            <ul class="list-unstyled">
                                                <li class="price"><?php echo $fetch_package['price']; ?><a href="#"><span class="arrow"><i class="fa fa-angle-right"></i></span></a></li>
                                            </ul>
                        ...
                        <div class="item">
                            <div class="member-block">
                                <div class="member-img">
                                    <img src="RDK_1731.JPG" class="img-fluid rounded-circle" alt="member-img" />
    ...
    <section id="message-banner" class="section-padding back-size">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-12 col-xl-3 message-btn text-xl-right">
...
<!-- Mirrored from kiswa.net/themes/star-travel/demo/demo-ltr/travel-agency-homepage.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Apr 2023 06:43:25 GMT -->
