...
<!-- Mirrored from kiswa.net/themes/star-travel/demo/demo-ltr/tour-listing-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Apr 2023 06:43:53 GMT -->
<head>
                    ...
                    <ul class="navbar-nav ml-auto navbar-search-link">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="dropdown-item" href="tour-listing-right-sidebar.html">List View Right Sidebar</a></li>
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                                ...
                                <div class="collapse sub-menu" id="tours-links">
                                    ...
                                    <a class="items-list active" href="tour-listing-right-sidebar.html">List View Right Sidebar</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Tour Listing Right Sidebar</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                        ...
                        <div class="col-12 col-md-12 col-lg-9 col-xl-9 content-side">
                            ...
                            <div class="list-block main-block t-list-block">
                                <div class="list-content">
                                    <div class="main-img list-img t-list-img">
                                        <a href="tour-detail-left-sidebar.html">
                                            <img src="images/tour-list-5.jpg" class="img-fluid" alt="tour-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                <li class="list-inline-item price">$568.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                            ...
                            <div class="list-block main-block t-list-block">
                                <div class="list-content">
                                    <div class="main-img list-img t-list-img">
                                        <a href="tour-detail-left-sidebar.html">
                                            <img src="images/tour-list-6.jpg" class="img-fluid" alt="tour-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                                                <li class="list-inline-item price">$568.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
