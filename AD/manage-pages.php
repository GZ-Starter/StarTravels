...
include('includes/sidebarmenu.php');
	...
	if ($_POST['submit']) {
		...
		$sql = "UPDATE tblpages SET details=:pagedetails WHERE type=:pagetype";
							...
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-sm-8">
											<select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
												...
												<option value="manage-pages.php?type=PrivacyPolicy">Privacy Policy</option>
												<option value="manage-pages.php?type=AboutUs">About Us</option>
												<option value="manage-pages.php?type=ContactUs">Contact Us</option>
											</select>	
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<?php
										$pagetype = $_GET['type'];
										$sql = "SELECT details from tblpages where type=:pagetype";
										$query = $dbh->prepare($sql);
										$query->bindParam(':pagetype', $pagetype, PDO::PARAM_STR);
										$query->execute();
										...
										if ($query->rowCount() > 0) {
											foreach ($results as $result) {
												echo htmlentities($result->details);
											}
										}
										?>
