...
$select = " SELECT * FROM tbllogin WHERE email = '$mail' and password='$password'";
$slct = " SELECT * FROM tblregister WHERE email = '$mail' and password='$password'";
$result = mysqli_query($conn, $select);
$res = mysqli_query($conn, $slct);

if(mysqli_num_rows($res)>0)
{
$con="update tbllogin set password='$newpassword' where email='$mail'";
$pas="update tblregister set password='$newpassword' where email='$mail'";
mysqli_query($conn, $con);
mysqli_query($conn, $pas);
