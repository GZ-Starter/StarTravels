...
if (strlen($_SESSION['name']) == 0) {
	...
	if (isset($_POST['submit'])) {
		$check=mysqli_query($conn,"SELECT MAX(packageId) from tblpackages");
		...
		$sql = mysqli_query($conn, "INSERT INTO tblpackages(name, price,image, packageId, packagelocation,packagefeatures,packagedetails,pickuppoint) VALUES('$pname','$pprice','$pimage','$pid','$plocation','$pfeatures','$pdetails','$pickup')");
			...
			<div class="left-content">
				...
				<div class="grid-form">
					...
					<div class="grid-form1">
						...
						<?php if(isset($error)){
							 foreach(@$error as $error) { ?><div class="errorWrap"><strong>ERROR</strong>:<?php echo "<span>.$error.</span>"; ?> </div>
							<?php }} if(isset($msg)){foreach (@$msg as $msg) { ?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo"<span>.$msg.</span>"; ?> </div>
								<?php }} ?>
							...
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
									...
									<!-- <div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control1" name="packageId" id="packageId" placeholder=" Package id" required>
										</div>
									</div> -->
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control1" name="pickup" id="pickup" placeholder=" Pickup location" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="file" name="image" accept="image/png, image/jpg, image/jpeg" id="packageimage" required>
										</div>
									</div>
